...
if __name__ == "__main__":
    ...
    # Types of categories
    topics = {1: "Anime Characters", 2:"Movies", 3:"Countries"}
 
    # Words in each category
    dataset = {
    "Anime Characters":["MONKEY D. LUFFY", "RORONOA ZORO", "LIGHT YAGAMI", "MIDORIYA IZUKU", "EREN YEAGER", "UZUMAKI NARUTO", "KIRITO", "LEVI", "MIKASA",
                        "DORAEMON", "NOBITA", "KUDO SHINICHI", "NATSU", "KANEKI"],
    "Movies":["HARRY POTTER", "TITANIC", "THE WINTER SOLDIER", "AVATAR", "ALICE IN WONDERLAND", "ETERNALS", "END GAME", "INCEPTION", "LIGHT OUT", "ANT MAN",
              "ANNABELLE", "THE NUN", "THE CONJURING", "AQUAMAN", "THE LORD OF THE RINGS", "FAST AND FURIOUS", "NICE GUY", "FANTASTIC BEASTS"],
    "Countries":["VIETNAM", "LAOS", "THAILAND", "AUSTRALIA", "CHINA", "USA", "RUSSIA", "UKRAINE", "GERMAN", "TAIWAN", "NETHERLANDS", "SLOVAKIA", "CAMBODIA",
                 "DUBAI", "HUNGARY", "VENEZUELA", "GREECE", "ITALY", "SWITZERLAND", "SOUTH KOREA", "NORTH KOREA", "JAPAN", "MEXICO", "CANADA", "TANZANIA",
                 "CUBA", "EGYPT", "INDIA", "UNITED KINGDOM", "SOUNTH AFRICA", "MOROCCO", "KENYA", "QUATAR", "MONGOLIA", "PHILIPPINES", "IRAN", "MALASIA",
                 "PAKISTAN", "MYANMAR", "TURKEY", "JORDAN", "ISRAEL", "UNITED ARAB EMIRATES", "UZBEKISTAN", "NEPAL", "SYRIA", "SAUDI ARABIA", "YEMEN"]
    }
